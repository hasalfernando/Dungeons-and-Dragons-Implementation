...
public class Character {
	...
	//Number of faces in the die relevant to the character class
	private static int diceType;
	//Abilities of the character
	private static int[] abilityValue; 
	private static int hpAbilityElement = 2;
	private static String[] abilityName = {"Strength", "Dexterity", "Constitution", "Intelligence","Wisdom","Charisma"};
	private static int[] abilityBonus;
	...
	public static skill chSkills, tempChSk;
	...
	public Character() throws IOException {
		...
		skill chSkills = new skill(userInput); //userInput holds the integer value related to the character class
		tempChSk = chSkills; //temporary link to chSkills for printing
	}
...
//		//Generate 3 Random numbers for each input and assign the sum of those three numbers for the input		
	...
	public void readUserConfirmation() {
		...
		do { //while user rejects the generated output	
			...
			System.out.println("Do you want to roll again ? Enter Y for yes, any other key for no.");
	...
	public static void printFinalResult() {
		printResult();
		tempChSk.printSkills();
//		chSkills.printSkills();
	}
